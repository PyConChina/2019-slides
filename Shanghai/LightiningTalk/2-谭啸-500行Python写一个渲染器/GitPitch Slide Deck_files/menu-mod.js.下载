					...
					function createSlideMenu() {
						if ( !document.querySelector('section[data-markdown]:not([data-markdown-parsed])') ) {
							...
							var menuTitle = create("div", {class: 'toc-title'},
								'<div class="pitch-menu-logo"></div><p style="color: white; padding: 20px 0 10px 0;"><i class="fa fa-list" style="padding-right: 5px"></i> Table of Contents</p><hr class="fade-away">');
